...
class ModelOwner:
  ...
  """
    ...
    """
        ...
        model.add(keras.layers.Conv2D(2, (3, 3), input_shape=(28, 28, 1)))
        model.add(keras.layers.Flatten())
        model.add(keras.layers.Dense(num_classes, name='logit'))'''
...
if __name__ == "__main__":
    ...
    data_owners = [
        DataOwner(
            "data-owner-0", "./MNIST_DATA/8Parties/data_party0.npz", model_owner.build_update_step
        ),
        DataOwner(
            "data-owner-1", "./MNIST_DATA/8Parties/data_party1.npz", model_owner.build_update_step
        ),
        DataOwner(
            "data-owner-2", "./MNIST_DATA/8Parties/data_party2.npz", model_owner.build_update_step
        ),
        DataOwner(
            "data-owner-3", "./MNIST_DATA/8Parties/data_party3.npz", model_owner.build_update_step
        ),
        DataOwner(
            "data-owner-4", "./MNIST_DATA/8Parties/data_party4.npz", model_owner.build_update_step
        ),
        DataOwner(
            "data-owner-5", "./MNIST_DATA/8Parties/data_party5.npz", model_owner.build_update_step
        ),
        DataOwner(
            "data-owner-6", "./MNIST_DATA/8Parties/data_party6.npz", model_owner.build_update_step
        ),
        DataOwner(
            "data-owner-7", "./MNIST_DATA/8Parties/data_party7.npz", model_owner.build_update_step
        ),
    ]
