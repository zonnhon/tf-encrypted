...
if __name__ == "__main__":
    ...
    data_owners = [
        DataOwner(
            "data-owner-0", "./MNIST_DATA/4Parties/data_party0.npz", model_owner.build_update_step
        ),
        DataOwner(
            "data-owner-1", "./MNIST_DATA/4Parties/data_party1.npz", model_owner.build_update_step
        ),
        DataOwner(
            "data-owner-2", "./MNIST_DATA/4Parties/data_party2.npz", model_owner.build_update_step
        ),
        DataOwner(
            "data-owner-3", "./MNIST_DATA/4Parties/data_party3.npz", model_owner.build_update_step
        ),
    ]
